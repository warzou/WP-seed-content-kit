# Handoff site — WP Seed Content Kit 0.8.0-rc.2
...
Artefact requis : ZIP officiel WP Seed Content Kit 0.8.0-rc.2, accompagné de son tag, de son commit, de sa taille et de son SHA-256 publiés. Ne consommer aucun worktree ou build local.
