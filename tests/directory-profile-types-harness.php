...
dpt_same(array(11, 13), wp_seed_content_directory_get_entries(array('ids' => array(11, 13))), 'Explicit IDs restrict the canonical population');
dpt_same(array(12, 13, 14, 15, 16, 18, 19, 20, 21, 22, 23, 25, 28, 29, 30), wp_seed_content_directory_get_entries(array('exclude_ids' => array(11, 11))), 'Exclusions apply without explicit IDs and ignore duplicates');
dpt_same(array(11, 13), wp_seed_content_directory_get_entries(array('ids' => array(11, 13), 'exclude_ids' => array(29))), 'Disjoint exclusions leave explicit IDs unchanged');
dpt_same(array(13), wp_seed_content_directory_get_entries(array('ids' => array(11, 13), 'exclude_ids' => array(11))), 'Intersection removes an explicitly included ID');
dpt_same(array(), wp_seed_content_directory_get_entries(array('ids' => array(11, 13), 'exclude_ids' => array(11, 13))), 'All explicit IDs excluded returns an empty result');
dpt_same(array(13), wp_seed_content_directory_get_entries(array('ids' => array(11, 11, 13, 13), 'exclude_ids' => array(11, 11))), 'Duplicate IDs and exclusions are normalized before intersection');
dpt_same(array(), wp_seed_content_directory_get_entries(array('ids' => array(999999), 'exclude_ids' => array())), 'Nonexistent explicit ID returns an empty result');
dpt_same(array(), wp_seed_content_directory_get_entries(array('ids' => array('11'), 'exclude_ids' => array())), 'Invalid explicit IDs fail closed');
dpt_same(array(), wp_seed_content_directory_get_entries(array('ids' => array(11), 'exclude_ids' => array('13'))), 'Invalid exclusions fail closed');
dpt_same(array(), wp_seed_content_directory_get_entries(array('ids' => array(24, 11), 'exclude_ids' => array(11))), 'Unlisted explicit profile is never widened back into the result');
dpt_same(array(), wp_seed_content_directory_get_entries(array('ids' => array(17, 11), 'exclude_ids' => array(11))), 'Draft explicit profile remains private after exclusion');
$GLOBALS['dpt_posts'][28]->post_password = 'protected';
dpt_same(array(), wp_seed_content_directory_get_entries(array('ids' => array(28, 11), 'exclude_ids' => array(11))), 'Protected explicit profile remains private after exclusion');
$GLOBALS['dpt_posts'][28]->post_password = '';
dpt_same(array(), wp_seed_content_directory_get_entries(array('ids' => array(27, 11), 'exclude_ids' => array(11))), 'Private explicit profile remains private after exclusion');
dpt_same(array(13), wp_seed_content_directory_get_entries(array('ids' => array(11, 13, 19), 'exclude_ids' => array(11), 'profile_types' => array('praticien', 'intervenant'), 'profile_type_operator' => 'and')), 'AND profile types apply after intersection');
dpt_same(array(13, 19), wp_seed_content_directory_get_entries(array('ids' => array(11, 13, 19), 'exclude_ids' => array(11), 'profile_types' => array('praticien', 'intervenant'), 'profile_type_operator' => 'or')), 'OR profile types apply after intersection');
dpt_same(array(15), wp_seed_content_directory_get_entries(array('ids' => array(14, 15, 22), 'exclude_ids' => array(14, 22), 'seeking_models' => '1')), 'Seeking models applies after intersection');
dpt_same(array(13), wp_seed_content_directory_get_entries(array('ids' => array(11, 12, 13, 14), 'exclude_ids' => array(11), 'offset' => 1, 'limit' => 1)), 'Offset and limit apply after exclusion and canonical ordering');
dpt_same(array(13, 14), wp_seed_content_directory_get_entries(array('ids' => array(11, 12, 13, 14), 'exclude_ids' => array(11), 'offset' => 1, 'limit' => 2)), 'Pagination window is calculated after exclusion');
dpt_same(array(14, 13), wp_seed_content_directory_get_entries(array('ids' => array(11, 13, 14), 'exclude_ids' => array(11), 'orderby' => 'id', 'order' => 'desc')), 'Canonical order is applied after intersection');
