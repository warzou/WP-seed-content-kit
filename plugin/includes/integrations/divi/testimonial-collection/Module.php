...
namespace WPSeedContentKit\Divi\TestimonialCollection;
...
class Module implements DependencyInterface
{
    ...
    public static function render_callback($attrs, $content, $block, $elements)
    {
        ...
        $collection = \wp_seed_content_render_testimonial_collection(
            \wp_seed_content_divi_testimonial_collection_args($attrs),
            true
        );
        ...
        $inner = HTMLUtility::render(
            array(
                'tag' => 'div',
                'attributes' => array(
                    'class' => 'wp-seed-divi-testimonial-collection__inner',
                ),
