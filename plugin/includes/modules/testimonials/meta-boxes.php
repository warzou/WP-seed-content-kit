...
function wp_seed_content_add_testimonial_meta_boxes()
{
    add_meta_box(
        ...
        __('Testimonial Details', 'wp-seed-content-kit'),
...
function wp_seed_content_render_testimonial_meta_box($post)
{
    ...
    ?>
    <p>
        <label for="wp_seed_content_testimonial_name"><strong><?php esc_html_e('Name or initials', 'wp-seed-content-kit'); ?></strong></label><br>
    ...
    <p>
        <label for="wp_seed_content_testimonial_text"><strong><?php esc_html_e('Text', 'wp-seed-content-kit'); ?></strong></label><br>
    ...
    <p>
        <label for="wp_seed_content_testimonial_context"><strong><?php esc_html_e('Context', 'wp-seed-content-kit'); ?></strong></label><br>
