...
function wp_seed_content_directory_register_post_type()
{
    $labels = array(
        ...
        'featured_image' => __('Photo de la personne', 'wp-seed-content-kit'),
        'set_featured_image' => __('Choisir la photo de la personne', 'wp-seed-content-kit'),
    ...
    wp_seed_content_directory_register_builder_meta();
    if (function_exists('wp_seed_content_directory_register_contacts_meta')) {
