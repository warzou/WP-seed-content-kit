...
function wp_seed_content_directory_register_post_type()
{
    $labels = array(
        ...
        'singular_name' => __('Fiche', 'wp-seed-content-kit'),
        'menu_name' => __('Annuaire', 'wp-seed-content-kit'),
        'add_new' => __('Ajouter une fiche', 'wp-seed-content-kit'),
        'add_new_item' => __('Ajouter une fiche', 'wp-seed-content-kit'),
        'edit_item' => __('Modifier la fiche', 'wp-seed-content-kit'),
        'new_item' => __('Nouvelle fiche', 'wp-seed-content-kit'),
        'search_items' => __('Rechercher dans l’annuaire', 'wp-seed-content-kit'),
        'not_found' => __('Aucune fiche trouvée', 'wp-seed-content-kit'),
        'not_found_in_trash' => __('Aucune fiche trouvée dans la corbeille', 'wp-seed-content-kit'),
        'all_items' => __('Fiches', 'wp-seed-content-kit'),
        'attributes' => __('Attributs de la fiche', 'wp-seed-content-kit'),
        ...
        'filter_items_list' => __('Filtrer la liste des fiches', 'wp-seed-content-kit'),
        'items_list_navigation' => __('Navigation de la liste des fiches', 'wp-seed-content-kit'),
        'items_list' => __('Liste des fiches', 'wp-seed-content-kit'),
    );
