...
function wp_seed_content_directory_admin_styles()
{
    ...
    echo '<style>.seed-directory-field-group{margin:0 0 20px;padding:0;border:0}.seed-directory-field-group legend{font-size:14px;margin-bottom:4px}.seed-directory-contact{margin:14px 0;padding:12px;border-left:4px solid #c3c4c7;background:#f6f7f7}.seed-directory-contact legend{padding:0 4px}.seed-directory-contact .regular-text{display:block;width:100%;max-width:520px;margin:6px 0 10px}.seed-directory-visibility{display:inline-block}.seed-directory-secondary{margin-top:20px;padding-top:16px;border-top:1px solid #dcdcde}.seed-directory-field-error{color:#b32d2e;font-weight:600}.seed-directory-field-error .dashicons{font-size:18px;width:18px;height:18px}input[aria-invalid=true],select[aria-invalid=true],textarea[aria-invalid=true]{border-color:#d63638;box-shadow:0 0 0 1px #d63638}@media(max-width:782px){.seed-directory-contact .regular-text{max-width:none}.column-directory_photo,.column-directory_department{display:none}}</style>';
}
